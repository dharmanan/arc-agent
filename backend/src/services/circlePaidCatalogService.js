...
function buildCirclePaidCatalogItems() {
  return [
    buildCirclePaidItem({
      ...
      sourceServices: ['Alchemy', 'Arc indexed activity ledger'],
      ...
      whatYouGet: 'A simple readout of balances, token mix, current positions, and a yesterday recap for indexed Arc wallets, plus the best-matching paid actions to take next.',
      howItWorks: [
        'Reads the connected Arc Testnet wallet and token balances.',
        'Summarizes the current holdings in plain English.',
        'Adds a yesterday UTC recap when the wallet already exists as an indexed Arc agent.',
